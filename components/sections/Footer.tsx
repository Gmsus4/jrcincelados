    ...
    <footer className="md:bg-white bg-darkB p-4 pt-2">
       <div className="bg-darkB rounded-lg">
          <div className="max-w-7xl mx-auto md:p-20 sm:p-10 sm:pt-36 p-4">
            ...
            {/* Redes sociales */}
            <div className="flex items-center justify-between border-t border-neutral-800 pt-6 flex-col sm:flex-row gap-4">
            ...
            {/* Credito */}
            <div className="text-xs text-neutral-400 mt-4 text-center sm:text-right">
              Hecho con{" "}
              <IconHeart size={12} className="inline text-red-500" /> por{" "}
              <Link href="https://www.tagblade.com" target="_blank" className="underline hover:text-white">
                Tagblade
              </Link>
            </div>
          </div>
